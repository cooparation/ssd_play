...
if __name__ == "__main__":
  ...
  cur_root = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
    #cmd = "{}/build/tools/convert_annoset" \
  if anno_type == "detection":
    cmd = "{}/ssd_play/convert_annoset" \
        " --anno_type={}" \
        " --label_type={}" \
        " --label_map_file={}" \
        " --check_label={}" \
        ...
        " --gray={}" \
        " {} {} {}" \
        .format(cur_root, anno_type, label_type, label_map_file, check_label,
    ...
    cmd = "{}/ssd_play/convert_annoset" \
        ...
        " --gray={}" \
        " {} {} {}" \
        .format(cur_root, anno_type, min_dim, max_dim, resize_height,
